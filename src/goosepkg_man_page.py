...
# We could substitute the "" in .TH with the goosepkg version if we knew it
man_header = """\
.\\" man page for goosepkg
.TH goosepkg 1 "%(today)s" "" "RPM packager"
.SH "NAME"
goosepkg \- RPM Packaging utility
.SH "SYNOPSIS"
.B "goosepkg"
[
.I global_options
...
man_footer = """\
.SH "SEE ALSO"
.UR "https://github.com/gooseproject/goosepkg"
"""
...
if __name__ == '__main__':
    try:
        import goosepkg
        client = goosepkg.cli.goosepkgClient(config=None)
    except ImportError:
        sys.path.append('src/pygoosepkg')
        import goosepkg
        client = goosepkg.cli.goosepkgClient(config=None)
